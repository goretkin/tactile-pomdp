...
class fwSettings(object):
    ...
    # Physics options
    hz=60.0
    velocityIterations=100 #8
    positionIterations=100 #3
    enableWarmStarting=False #True   # Makes physics results more accurate (see Box2D wiki)
...
sliders = [
    ...
    { 'name' : 'particlePlotThresh', 'text' : 'Plot Thresh', 'min' : 0, 'max' : 100}
]
