...
print("pyqt4_gui_two_views.py")

class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        print("setupUI in pyqt4_gui_two_views.py")
        ...
        self.viewportsLayout = QtGui.QVBoxLayout(self.centralwidget)

        self.graphicsView = QtGui.QGraphicsView(self.centralwidget)
        self.graphicsView.setObjectName(_fromUtf8("graphicsView_isthisimportant"))
        self.viewportsLayout.addWidget(self.graphicsView)

        self.graphicsViewAlternate = QtGui.QGraphicsView(self.centralwidget)
        self.graphicsViewAlternate.setObjectName(_fromUtf8("graphicsViewAlternate"))
        self.viewportsLayout.addWidget(self.graphicsViewAlternate)
