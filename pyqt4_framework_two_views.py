...
from pyqt4_gui_two_views import Ui_MainWindow
...
print("pyqt4_framework_two_views")
...
class Pyqt4Draw(object):
    ...
    def __init__(self, test):
        print("Pyqt4Draw constructor in pyqt4_framework_two_views")
        self.test=test
    ...
    def ManualDraw(self):
        ...
        if settings.drawShapes:
            ...
            for item in list(self.item_cache.keys()):
